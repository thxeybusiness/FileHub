...
const TYPE_META: Record<string, { label: string; icon: typeof FileIcon; tint: string }> = {
  ...
  design: { label: "Designs", icon: Shapes, tint: "text-purple-300 bg-purple-500/10" },
  coaching: { label: "Accompagnements", icon: HeartHandshake, tint: "text-cyan-300 bg-cyan-500/10" },
};

const TYPE_ORDER = ["folder", "file", "doc", "sheet", "chart", "draw", "slides", "board", "project", "note", "diagram", "da", "design", "coaching"];

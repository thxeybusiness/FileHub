...
export type SerializedNode = {
  ...
  name: string;
  type: "folder" | "file" | "doc" | "sheet" | "chart" | "draw" | "note" | "diagram" | "board" | "slides" | "project" | "coaching" | "seance";
  color: string | null;
...
export function serializeNode(n: NodeRow): SerializedNode {
  return {
    ...
    parentId: n.parentId,
    name: n.name,
    type: n.type as "folder" | "file" | "doc" | "sheet" | "chart" | "draw" | "note" | "diagram" | "board" | "slides" | "project" | "coaching" | "seance",
    color: n.color,
    mimeType: n.mimeType,
    size: Number(n.size),
    starred: n.starred,
